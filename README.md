...
[![Version](https://img.shields.io/badge/version-0.1.6--dev2-blue?logo=github)](https://github.com/jessp/godot-mcp)
...
- **Adding a tool** requires adding a `register_<group>()` function in `extensions/gdext/src/commands/handler_registry.cpp`.
