...
## 2026-06-04 — 节点属性工具扩充系统设计

- **新增** `design/node-property-system.md`：节点属性工具扩充系统完整设计方案（YAML 数据库 + 通用工具模板 + codegen 自动生成）
- **更新** `AGENTS.md`：删除已完成的 4 阶段优化计划详细内容，替换为完成摘要表；新增节点属性系统规划章节；更新工具分组表添加 `node_prop/*` 条目
