...
class GetNodeRotation3DTool : public ITool {
public:
    String name() const override { return "get_node_rotation_3d"; }
    String category() const override { return "property_3d"; }
    String brief() const override { return "Get a Node3D's rotation in degrees"; }
    bool needs_scene() const override { return true; }
    bool needs_node() const override { return true; }
    String description() const override { return "Gets the 3D rotation_degrees (x, y, z) of a Node3D."; }
...
protected:
    Dictionary execute_impl(const ToolContext &ctx) override {
        ...
        Vector3 v = ctx.node->get("rotation_degrees");
