...
protected:
    Dictionary execute_impl(const ToolContext &) override {
        ...
        d["draw_calls_in_frame"] = p->get_monitor(godot::Performance::RENDER_TOTAL_DRAW_CALLS_IN_FRAME);
        d["video_mem_mb"] = p->get_monitor(godot::Performance::RENDER_VIDEO_MEM_USED) / 1048576.0;
        d["texture_mem_mb"] = p->get_monitor(godot::Performance::RENDER_TEXTURE_MEM_USED) / 1048576.0;
        d["buffer_mem_mb"] = p->get_monitor(godot::Performance::RENDER_BUFFER_MEM_USED) / 1048576.0;
