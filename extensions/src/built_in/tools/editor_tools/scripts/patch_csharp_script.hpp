...
class PatchCsharpScriptTool : public ITool {
public:
    String name() const override { return "patch_csharp_script"; }
    String category() const override { return "editor_tools/scripts"; }
    String brief() const override {
        return String::utf8("精确替换 C# Script (.cs) 文件中的文本");
    }
    String description() const override {
        return String::utf8("在 C# 脚本文件中执行精确文本替换。将 old_text 替换为 new_text，适用于手术式修改而非重写整个文件。occurrence=0 时替换所有匹配项，>0 时只替换第 N 次出现的匹配项。");
    }
