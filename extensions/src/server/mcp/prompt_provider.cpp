...
const PromptEntry kPrompts[] = {
    ...
    { "fix_error",     "Analyze an editor error or script error and suggest fixes", &make_fix_error_prompt,  &add_error_text_arg },
    { "explain_node",  "Explain what a Godot node type does and common usage patterns", &make_explain_node_prompt, &add_node_type_arg },
