...
hero:
  ...
  features:
    ...
    - title: Runtime Bridge
      details: Query and control running game instances via TCP bridge (port 9601)
    - title: ClassDB Documentation
      details: Documentation tools query Godot runtime class database -- zero maintenance